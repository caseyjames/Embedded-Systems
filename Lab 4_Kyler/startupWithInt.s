@	startupWithInt.s
@	Complete startup Interrupt Vector Table for SmartFusion ARM Cortex-M3
@	By Lohit Yerva
...
intVectors:
	...
	@ Start of the Nested Interrupt Vector Controller table 
	
    .word  WdogWakeup_IRQHandler		@ IRQ number 0
    .word  BrownOut_1_5V_IRQHandler		@ IRQ number 1
    .word  BrownOut_3_3V_IRQHandler		@ IRQ number 2
    ...
    .word  0
    .word  0
    .word  Fabric_IRQHandler			@ IRQ number 31
    .word  GPIO0_IRQHandler
    .word  GPIO1_IRQHandler
    .word  GPIO2_IRQHandler				@ IRQ number 33
